...
(um_userId,um_password,um_firstName,um_lastName,um_gender,um_contact,um_emailId,um_isActive,um_Salary,um_Designation,um_PerAddress,um_CorAddress,um_created_On,um_created_by,um_IsApprovedOn,um_IsApprovedBy,um_RoleId)
values
('superadmin','123456','Super','Administrator','Male','9848012345','superadmin@gmail.com',1, 500000, 'CEO','Chennai','Chennai',getdate(),'System',getdate(),'System',1),
('admin','123456','Administrator','Sample','Male','9849012345','admin@gmail.com',1, 400000, 'Manager','Chennai','Chennai',getdate(),'System',getdate(),'System',2),
('staff','123456','Staff','Sample','Male','9899012345','agent@gmail.com',1, 300000, 'Employee','Chennai','Chennai',getdate(),'System',getdate(),'System',3),
('user','123456','User','Sample','Male','7899012345','user@gmail.com',1,NULL, NULL,'Chennai','Chennai',getdate(),'System',getdate(),'System',4)
...
values
('Hyderabad',1),('Chennai',1),('Banglore',1),('Pune',1),('Mumbai',1),('Kolkata',1),('Delhi',1)